const CACHE='sidedesk-shell-v7-participants';
const CORE=['/sidedesk/','/sidedesk/style-v3.css','/sidedesk/app-v3.js','/sidedesk/manifest.webmanifest','/sidedesk/icon.svg','/firebase-config.js'];
